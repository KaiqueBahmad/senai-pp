...
public class SorterPorSituacaoENome extends Sorter implements Comparator {
	@Override
	...
	public int compare(Object o1, Object o2) {
        Aluno a1 = (Aluno) o1;
        Aluno a2 = (Aluno) o2;
        int compareSituacao = a1.situacao.compareTo(a2.situacao);
        if (compareSituacao != 0) return compareSituacao;
